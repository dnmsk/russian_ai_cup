...
#ap ground_vehicles
      ...
      ground_vehicles.map do |v|
        Strategies::Actions::Base.new(@my_world, "init_#{v[0]}".to_sym, [
      ...
      [
        Strategies::Actions::Base.new(@my_world, :init_1, [
          { name: :select, act: ->(rectangle) { rectangle }},
        ...
        Strategies::Actions::Base.new(@my_world, :init_2, [
          { name: :select, act: ->(rectangle) { rectangle }},
      ...
      [
        Strategies::Actions::Base.new(@my_world, :grouping_1, [
        ...
        Strategies::Actions::Base.new(@my_world, :grouping_2, [
        ...
        Strategies::Actions::Base.new(@my_world, :scaling, [
          { name: :select, act: ->(rectangle) { rectangle }},
